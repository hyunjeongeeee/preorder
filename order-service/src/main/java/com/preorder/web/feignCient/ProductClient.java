...
public interface ProductClient {
    // product-service 에서 특정 상품 정보를 가져오는 엔드포인트를 호출
    ...
    ProductStockResponse updateStock(@PathVariable(value = "productId") long productId,  @RequestParam("productCount") int productCount);
